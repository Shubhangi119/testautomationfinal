...
public class Testtictac {	
	...
	public static String driverpath="Resources/chromedriver";
	
	@BeforeClass
	public static void setup() {
		System.setProperty("webdriver.chrome.driver",driverpath);
		driver = new ChromeDriver();
		driver.get("http://10.0.1.86/tap_classroom/TicTacToe/");
...
//			
	...
	public static void markMoveOnBoard(char player, String move)
	{
		...
		int d= 11+((10*row)+column);
		String a= Integer.toString(d);
         String locator = "td[id='num']";
		
		String locClick = locator.replaceAll("num", a);
		
		driver.findElement(By.cssSelector(locClick)).click();
